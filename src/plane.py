...
class Plane:
    ...
    planes_of_interest = ['G-OBMS', 'G-BODE', 'G-BODB', 'G-BNOH', 'G-SACS', 'G-SACT', 'G-SACY', 'G-SACX', 'G-SACP',
                          'G-SACW']
    ...
    def update_nearest(self):
        ...
        self.from_antenna = distance_on_sphere(float(self.lat), float(self.long), Plane.antenna_location[0],
